// Cloudflare Worker — Highlight Generator
// LLM으로 하이라이트 후보 구간 추천
...
- estimated_seconds는 한국어 말하기 속도 기준 (초당 약 5~6자)
- 총 후보의 합산이 60~90초 분량이 되도록 (편집자가 30~40초로 줄일 수 있게)`;
...
export default {
  async fetch(request, env) {
        ...
        var res = await fetch("https://api.openai.com/v1/chat/completions", {
          ...
          body: JSON.stringify({
            ...
            messages: [
              ...
              { role: "user", content: compressScript(script, 14000) },
            ],
            temperature: 0.5,
            max_tokens: 2000,
          }),
    ...
    return new Response("Highlight Generator Worker", { headers: cors });
  },
};
